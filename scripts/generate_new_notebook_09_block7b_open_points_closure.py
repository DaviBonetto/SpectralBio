        ...
        code_cell(
            dedent(
                ...
                block1_summary = json.loads(resolve_existing_path(
                    ...
                    SHARED_INPUTS_DIR / 'block1' / 'block1_summary.json',
                ...
                block4_summary = json.loads(resolve_existing_path(
                    ...
                    SHARED_INPUTS_DIR / 'block4' / 'block4_summary.json',
                ).read_text(encoding='utf-8'))
                ...
                block5_summary = json.loads(resolve_existing_path(
                    ...
                    SHARED_INPUTS_DIR / 'block5' / 'block5_summary.json',
                ).read_text(encoding='utf-8'))
                ...
                block6_summary = json.loads(resolve_existing_path(
                    ...
                    SHARED_INPUTS_DIR / 'block6' / 'block6_summary.json',
                ).read_text(encoding='utf-8'))
                ...
                block10b_summary = json.loads(resolve_existing_path(
                    ...
                    SHARED_INPUTS_DIR / 'block10b' / 'block10_summary.json',
                ).read_text(encoding='utf-8'))
