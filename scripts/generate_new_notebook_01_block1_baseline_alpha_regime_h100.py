...
def build_notebook() -> dict:
    cells = [
        ...
        code_cell(
            "# Preflight: ensure Lightning has the runtime dependencies needed for ESM-1v loading\n"
            ...
            "if missing_packages:\n"
            "    subprocess.check_call([sys.executable, '-m', 'pip', 'install', '--quiet', *missing_packages], cwd=str(REPO_ROOT))\n"
            ...
            "}\n"
            "display(pd.DataFrame([runtime_probe]))\n"
            "done('Preflight de dependências concluído.')\n"
        ),
        code_cell(
...
def main() -> None:
    ...
    output_path = repo_root / "New Notebooks" / "01_block1_baseline_alpha_regime_audit_h100.ipynb"
